...
export const metadata: Metadata = {
  title: 'CodeWhiz',
  description:
    'CodeWhiz is a community of developers for asking and answering programming questions. We are a community of like-minded people who want to learn, create, and grow together.',
  icons: [],
};
